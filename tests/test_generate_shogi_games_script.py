...
class GenerateShogiGamesScriptTest(unittest.TestCase):
    def test_checkpoint_fixed_side_writes_game_records(self) -> None:
        ...
        self.assertEqual(records[0].black_actor.settings["move_selection_temperature"], 1.0)
        self.assertEqual(records[0].white_actor.settings["move_selection_temperature"], 1.0)
        self.assertEqual(records[0].black_actor.settings["move_selection_temperature_plies"], 40)
        self.assertEqual(records[0].white_actor.settings["move_selection_temperature_plies"], 40)
    ...
    def test_random_legal_start_positions_use_one_position_per_game(self) -> None:
        module = _load_script_module()
        ...
        self.assertEqual(records[1].initial_position_sfen, start_positions[1]["sfen"])
        self.assertEqual(summary["game_count"], 2)
