...
class MatchEvaluationTest(unittest.TestCase):
    def test_summarizes_player_results_by_side(self) -> None:
        ...
        self.assertEqual(evaluation.player_a_black_game_count, 1)
        self.assertEqual(evaluation.player_a_white_game_count, 1)
        ...
        self.assertEqual(evaluation.player_a_wins, 0)
        self.assertEqual(evaluation.player_a_losses, 0)
        self.assertEqual(evaluation.player_b_wins, 0)
        self.assertEqual(evaluation.player_b_losses, 0)
